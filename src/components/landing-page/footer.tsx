...
const Footer = () => {
  return (
    <footer className="w-full py-6 mb-20 mt-20 border-t border-brand-primaryPurple/70">
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center">
        <div className="text-center sm:text-left">
          <aside className="flex items-center justify-center sm:justify-start mb-4 sm:mb-0">
            <Image
              src={'/logo.webp'}
              width={40}
              height={40}
              alt="logo"
            />
            <h2 className="text-xl font-bold">Notable</h2>
          </aside>
          <p>Contact us: info@notable.com</p>
        </div>
        <div>
          ...
          <p className="text-center sm:text-left">&copy; {new Date().getFullYear()} Notable. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
